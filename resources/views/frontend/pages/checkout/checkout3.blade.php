...
@section('content')
    ...
    <!-- Breadcumb Area -->{{-- area checked ep26-27 5100 --}}
                        ...
                        <div class="checkout_details_area clearfix">
                            <div class="payment_method">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    {{-- <!-- Single Payment Method (Direct Bank Transfer) -->
                                    <div class="panel panel-default">
                                    ...
                                    {{-- <!-- Single Payment Method (Cheque Payment)-->
                                    <div class="panel panel-default">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="five">
                                            <h6 class="panel-title">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" required name="payment_method" value="cod" class="custom-control-input" id="customCheck2">{{-- checked ep26-27 20219 --}}
