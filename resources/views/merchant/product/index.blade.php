                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Product List
                            <a class="btn btn-sm btn-outline-secondary" href="{{route('merchant-product.create')}}"></i> Create Product</a></h2>
                                ...
                                <tbody>
                                    @foreach($products as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('merchant-product.show',$item->id)}}" data-toggle="tooltip" title="add attribute" class="float-left btn btn-sm btn-outline-secondary mr-1 mb-1" data-placement="bottom"><i class="icon-plus"></i> </a>{{-- checked ep32 1140 --}}                                                                                           
                                                ...
                                                <a href="{{route('merchant-product.edit',$item->id)}}" data-toggle="tooltip" title="edit" class="float-left btn btn-sm btn-outline-warning" data-placement="bottom"><i class="icon-pencil"></i> </a>
                                                <form class="float-left ml-1" action="{{route('merchant-product.destroy',$item->id)}}"  method="post">
                                                    @csrf
                                                    @method('delete')
...
@section('scripts')
    ...
    <script>
        $('input[name=toogle]').change(function () {
            ...
            // alert(id);
            $.ajax({
                url:"{{route('merchant.product.status')}}",
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
                    mode:mode,
