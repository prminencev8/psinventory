	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box">
                    <div class="top">
                        {{-- <img src="{{('backend/assets/images/logo-white.svg')}}" alt="Logo"> --}}
                    </div>
					<div class="card">
                        <div class="header">
                            <p class="lead">Login to your merchant account</p>
                        </div>
                        <div class="body">
                            <form class="form-auth-small" method="POST" action="{{route('merchant.login')}}">
                                @csrf
