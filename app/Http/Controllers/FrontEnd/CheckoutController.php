        ...
        //        return $request->all();
            ...
            public function checkout3Store(Request $request){
                ...
                //        return Session::get('checkout');
                        ...
                        $order['total_amount']=(float)str_replace(',','',Session::get('checkout')['sub_total'])+Session::get('checkout')[0]['delivery_charge'];
                        ...
                        if($status){
                            Mail::to($order['email'])->bcc($order['semail'])->cc('harrisalexander328@gmail.com')->send(new OrderMail($order));
